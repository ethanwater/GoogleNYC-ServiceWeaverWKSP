...
func init() {
	codegen.Register(codegen.Registration{
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return cache_client_stub{stub: stub, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "serviceweaver/Cache", Method: "Get", Remote: true}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "serviceweaver/Cache", Method: "Put", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦c9c9b6d2:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→serviceweaver/Searcher⟧\n⟦ae8d729f:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→emoji⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "serviceweaver/Searcher",
		Iface: reflect.TypeOf((*Searcher)(nil)).Elem(),
		Impl:  reflect.TypeOf(searcher{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return searcher_local_stub{impl: impl.(Searcher), tracer: tracer, searchMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "serviceweaver/Searcher", Method: "Search", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return searcher_client_stub{stub: stub, searchMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "serviceweaver/Searcher", Method: "Search", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
		...
		RefData: "⟦eb7e0ab3:wEaVeReDgE:serviceweaver/Searcher→serviceweaver/Cache⟧\n",
	})
}
